...
_Generated 2026-09-19 on darwin arm64, Apple M3, node v24.16.0._

**17 tasks · 7,413,786 naive tokens → 9,169 tool tokens · 99.9% saved overall · median 32ms per call**

| Tool | Task | Naive tokens | Tool tokens | Saved | Time |
|---|---|---:|---:|---:|---:|
| `query_table` | total sales by region (sales.csv) | 1,370,762 | 75 | 99.99% | 0.5s |
| `query_table` | how many rows have a negative total (sales.csv) | 1,370,762 | 37 | 100.00% | 0.4s |
| `query_table` | which columns exist and their types (sales.csv) | 1,370,762 | 186 | 99.99% | 0.3s |
| `summarize_log` | what's causing the 5xx spike (app.log) | 731,145 | 380 | 99.9% | 32ms |
| `summarize_log` | summarize this log (app.log) | 731,145 | 698 | 99.9% | 89ms |
...
| `query_file` | which functions call resolveInputs (src/**/*.ts) | 57,758 | 570 | 99.0% | 5ms |
| `validate_file` | is this 100k-row CSV well-formed (sales.csv) | 1,370,762 | 37 | 100.00% | 53ms |

Fixtures (generated locally, seeded): sales.csv 5.2 MB · app.log 2.8 MB · contract.pdf 206 KB · handbook.docx 29 KB (100,000 rows · 50,000 lines · 100 pages · ~18k words) · src/ 37 TypeScript files.
...
```
query_table · 1,370,762 → 75 tokens · 99.99% · 0.5s
query_table · 1,370,762 → 37 tokens · 100.00% · 0.4s
query_table · 1,370,762 → 186 tokens · 99.99% · 0.3s
summarize_log · 731,145 → 380 tokens · 99.9% · 32ms
summarize_log · 731,145 → 698 tokens · 99.9% · 89ms
file_map · 72,055 → 2,065 tokens · 97.1% · 0.2s
query_file · 72,055 → 713 tokens · 99.0% · 0.1s
read_section · 72,055 → 1,528 tokens · 97.9% · 0.1s
file_map · 31,699 → 483 tokens · 98.5% · 5ms
query_file · 31,699 → 310 tokens · 99.0% · 5ms
read_section · 31,699 → 1,166 tokens · 96.3% · 2ms
extract · 31,699 → 51 tokens · 99.8% · 3ms
diff_files · 63,429 → 293 tokens · 99.5% · 4ms
file_map · 2,697 → 318 tokens · 88.2% · 3ms
file_map · 1,603 → 259 tokens · 83.8% · 3ms
query_file · 57,758 → 570 tokens · 99.0% · 5ms
validate_file · 1,370,762 → 37 tokens · 100.00% · 53ms
```
