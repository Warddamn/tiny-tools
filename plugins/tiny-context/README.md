...
Install: `/plugin marketplace add Warddamn/tiny-tools` then `/plugin install tiny-context@tiny-tools` (needs Node 20+; the server runs via `npx -y -p https://github.com/Warddamn/tiny-tools/releases/download/v0.1.0/tiny-context-standalone-0.1.0.tgz tiny-context-mcp`).
